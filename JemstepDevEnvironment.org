...
* 4. Maintaining our agile startup culture as we grow is hard
...
* Summary
  ...
  1. Treat Developer Productivity as a first-class concern. Automate!
  2. Developer onboarding needs to be excellent
  3. Plan for decreased productivity when new people start
  4. Change how you communicate as you grow
  5. Multi-site development is only for the brave
